...
class NBTAdapterImpl : AbstractModule(), NBTAdapter {
    ...
    override fun createNBTLongArray(value: LongArray): WrapperNBTLongArray = throw UnsupportedOperationException("NBTLongArray is not supported under 1.11.2")
    ...
    override fun wrapNBTLongArray(tag: Any): WrapperNBTLongArray = throw UnsupportedOperationException("NBTLongArray is not supported under 1.11.2")
